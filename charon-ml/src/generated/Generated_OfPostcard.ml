...
type of_postcard_ctx = DeserializationCtx.t

let empty_of_postcard_ctx = DeserializationCtx.empty ()
...
and builtin_adt_of_postcard (ctx : of_postcard_ctx) (st : postcard_state) :
...
and type_decl_ref_of_postcard (ctx : of_postcard_ctx) (st : postcard_state) :
  ...
  combine_error_msgs st __FUNCTION__
    (let* id = type_decl_id_of_postcard ctx st in
     let* generics = box_of_postcard generic_args_of_postcard ctx st in
     let* builtin = option_of_postcard builtin_adt_of_postcard ctx st in
...
and rustc_lang_item_of_postcard (ctx : of_postcard_ctx) (st : postcard_state) :
  ...
  combine_error_msgs st __FUNCTION__
    (let* __tag = int_of_postcard ctx st in
     ...
     | 19 -> Ok RustcLangItemNonNull
     | 20 -> Ok RustcLangItemFreeze
     | 21 -> Ok RustcLangItemUnsafeUnpin
     | 22 -> Ok RustcLangItemFnPtrTrait
     | 23 -> Ok RustcLangItemFnPtrAsPtr
     | 24 -> Ok RustcLangItemFnPtrFromPtr
     | 25 -> Ok RustcLangItemCode
     | 26 -> Ok RustcLangItemDrop
     | 27 -> Ok RustcLangItemDestruct
     | 28 -> Ok RustcLangItemAsyncDrop
     | 29 -> Ok RustcLangItemAsyncDropInPlace
     | 30 -> Ok RustcLangItemCoerceUnsized
     | 31 -> Ok RustcLangItemDispatchFromDyn
     | 32 -> Ok RustcLangItemTryAsDyn
     | 33 -> Ok RustcLangItemTransmuteOpts
     | 34 -> Ok RustcLangItemTransmuteTrait
     | 35 -> Ok RustcLangItemAdd
     | 36 -> Ok RustcLangItemSub
     | 37 -> Ok RustcLangItemMul
     | 38 -> Ok RustcLangItemDiv
     | 39 -> Ok RustcLangItemRem
     | 40 -> Ok RustcLangItemNeg
     | 41 -> Ok RustcLangItemNot
     | 42 -> Ok RustcLangItemBitXor
     | 43 -> Ok RustcLangItemBitAnd
     | 44 -> Ok RustcLangItemBitOr
     | 45 -> Ok RustcLangItemShl
     | 46 -> Ok RustcLangItemShr
     | 47 -> Ok RustcLangItemAddAssign
     | 48 -> Ok RustcLangItemSubAssign
     | 49 -> Ok RustcLangItemMulAssign
     | 50 -> Ok RustcLangItemDivAssign
     | 51 -> Ok RustcLangItemRemAssign
     | 52 -> Ok RustcLangItemBitXorAssign
     | 53 -> Ok RustcLangItemBitAndAssign
     | 54 -> Ok RustcLangItemBitOrAssign
     | 55 -> Ok RustcLangItemShlAssign
     | 56 -> Ok RustcLangItemShrAssign
     | 57 -> Ok RustcLangItemIndex
     | 58 -> Ok RustcLangItemIndexMut
     | 59 -> Ok RustcLangItemUnsafeCell
     | 60 -> Ok RustcLangItemCovariantUnsafeCell
     | 61 -> Ok RustcLangItemUnsafePinned
     | 62 -> Ok RustcLangItemVaArgSafe
     | 63 -> Ok RustcLangItemVaList
     | 64 -> Ok RustcLangItemComplex
     | 65 -> Ok RustcLangItemDeref
     | 66 -> Ok RustcLangItemDerefMut
     | 67 -> Ok RustcLangItemDerefPure
     | 68 -> Ok RustcLangItemDerefTarget
     | 69 -> Ok RustcLangItemReceiver
     | 70 -> Ok RustcLangItemReceiverTarget
     | 71 -> Ok RustcLangItemLegacyReceiver
     | 72 -> Ok RustcLangItemFn
     | 73 -> Ok RustcLangItemFnMut
     | 74 -> Ok RustcLangItemFnOnce
     | 75 -> Ok RustcLangItemFnStatic
     | 76 -> Ok RustcLangItemAsyncFn
     | 77 -> Ok RustcLangItemAsyncFnMut
     | 78 -> Ok RustcLangItemAsyncFnOnce
     | 79 -> Ok RustcLangItemAsyncFnOnceOutput
     | 80 -> Ok RustcLangItemCallOnceFuture
     | 81 -> Ok RustcLangItemCallRefFuture
     | 82 -> Ok RustcLangItemAsyncFnKindHelper
     | 83 -> Ok RustcLangItemAsyncFnKindUpvars
     | 84 -> Ok RustcLangItemFnOnceOutput
     | 85 -> Ok RustcLangItemIterator
     | 86 -> Ok RustcLangItemFusedIterator
     | 87 -> Ok RustcLangItemFuture
     | 88 -> Ok RustcLangItemFutureOutput
     | 89 -> Ok RustcLangItemAsyncIterator
     | 90 -> Ok RustcLangItemCoroutineState
     | 91 -> Ok RustcLangItemCoroutine
     | 92 -> Ok RustcLangItemCoroutineReturn
     | 93 -> Ok RustcLangItemCoroutineYield
     | 94 -> Ok RustcLangItemCoroutineResume
     | 95 -> Ok RustcLangItemUnpin
     | 96 -> Ok RustcLangItemPin
     | 97 -> Ok RustcLangItemOrderingEnum
     | 98 -> Ok RustcLangItemPartialEq
     | 99 -> Ok RustcLangItemPartialOrd
     | 100 -> Ok RustcLangItemCVoid
     | 101 -> Ok RustcLangItemType
     | 102 -> Ok RustcLangItemTypeGeneric
     | 103 -> Ok RustcLangItemTypeId
     | 104 -> Ok RustcLangItemPanic
     | 105 -> Ok RustcLangItemPanicNounwind
     | 106 -> Ok RustcLangItemPanicFmt
     | 107 -> Ok RustcLangItemPanicDisplay
     | 108 -> Ok RustcLangItemConstPanicFmt
     | 109 -> Ok RustcLangItemPanicBoundsCheck
     | 110 -> Ok RustcLangItemPanicMisalignedPointerDereference
     | 111 -> Ok RustcLangItemPanicInfo
     | 112 -> Ok RustcLangItemPanicLocation
     | 113 -> Ok RustcLangItemPanicImpl
     | 114 -> Ok RustcLangItemPanicCannotUnwind
     | 115 -> Ok RustcLangItemPanicInCleanup
     | 116 -> Ok RustcLangItemPanicAddOverflow
     | 117 -> Ok RustcLangItemPanicSubOverflow
     | 118 -> Ok RustcLangItemPanicMulOverflow
     | 119 -> Ok RustcLangItemPanicDivOverflow
     | 120 -> Ok RustcLangItemPanicRemOverflow
     | 121 -> Ok RustcLangItemPanicNegOverflow
     | 122 -> Ok RustcLangItemPanicShrOverflow
     | 123 -> Ok RustcLangItemPanicShlOverflow
     | 124 -> Ok RustcLangItemPanicDivZero
     | 125 -> Ok RustcLangItemPanicRemZero
     | 126 -> Ok RustcLangItemPanicCoroutineResumed
     | 127 -> Ok RustcLangItemPanicAsyncFnResumed
     | 128 -> Ok RustcLangItemPanicAsyncGenFnResumed
     | 129 -> Ok RustcLangItemPanicGenFnNone
     | 130 -> Ok RustcLangItemPanicCoroutineResumedPanic
     | 131 -> Ok RustcLangItemPanicAsyncFnResumedPanic
     | 132 -> Ok RustcLangItemPanicAsyncGenFnResumedPanic
     | 133 -> Ok RustcLangItemPanicGenFnNonePanic
     | 134 -> Ok RustcLangItemPanicNullPointerDereference
     | 135 -> Ok RustcLangItemPanicNullReferenceConstructed
     | 136 -> Ok RustcLangItemPanicInvalidEnumConstruction
     | 137 -> Ok RustcLangItemPanicCoroutineResumedDrop
     | 138 -> Ok RustcLangItemPanicAsyncFnResumedDrop
     | 139 -> Ok RustcLangItemPanicAsyncGenFnResumedDrop
     | 140 -> Ok RustcLangItemPanicGenFnNoneDrop
     | 141 -> Ok RustcLangItemBeginPanic
     | 142 -> Ok RustcLangItemFormatArgument
     | 143 -> Ok RustcLangItemFormatArguments
     | 144 -> Ok RustcLangItemDropGlue
     | 145 -> Ok RustcLangItemAllocLayout
     | 146 -> Ok RustcLangItemStart
     | 147 -> Ok RustcLangItemEhPersonality
     | 148 -> Ok RustcLangItemCompilerMove
     | 149 -> Ok RustcLangItemCompilerCopy
     | 150 -> Ok RustcLangItemOwnedBox
     | 151 -> Ok RustcLangItemGlobalAlloc
     | 152 -> Ok RustcLangItemPhantomData
     | 153 -> Ok RustcLangItemManuallyDrop
     | 154 -> Ok RustcLangItemMaybeDangling
     | 155 -> Ok RustcLangItemBikeshedGuaranteedNoDrop
     | 156 -> Ok RustcLangItemMaybeUninit
     | 157 -> Ok RustcLangItemTermination
     | 158 -> Ok RustcLangItemTry
     | 159 -> Ok RustcLangItemTuple
     | 160 -> Ok RustcLangItemSliceLen
     | 161 -> Ok RustcLangItemTryTraitFromResidual
     | 162 -> Ok RustcLangItemTryTraitFromOutput
     | 163 -> Ok RustcLangItemTryTraitBranch
     | 164 -> Ok RustcLangItemTryTraitFromYeet
     | 165 -> Ok RustcLangItemResidualIntoTryType
     | 166 -> Ok RustcLangItemCoercePointeeValidated
     | 167 -> Ok RustcLangItemConstParamTy
     | 168 -> Ok RustcLangItemPoll
     | 169 -> Ok RustcLangItemPollReady
     | 170 -> Ok RustcLangItemPollPending
     | 171 -> Ok RustcLangItemAsyncGenReady
     | 172 -> Ok RustcLangItemAsyncGenPending
     | 173 -> Ok RustcLangItemAsyncGenFinished
     | 174 -> Ok RustcLangItemResumeTy
     | 175 -> Ok RustcLangItemGetContext
     | 176 -> Ok RustcLangItemContext
     | 177 -> Ok RustcLangItemFuturePoll
     | 178 -> Ok RustcLangItemAsyncIteratorPollNext
     | 179 -> Ok RustcLangItemIntoAsyncIterIntoIter
     | 180 -> Ok RustcLangItemOption
     | 181 -> Ok RustcLangItemOptionSome
     | 182 -> Ok RustcLangItemOptionNone
     | 183 -> Ok RustcLangItemResultOk
     | 184 -> Ok RustcLangItemResultErr
     | 185 -> Ok RustcLangItemControlFlowContinue
     | 186 -> Ok RustcLangItemControlFlowBreak
     | 187 -> Ok RustcLangItemIntoFutureIntoFuture
     | 188 -> Ok RustcLangItemIntoIterIntoIter
     | 189 -> Ok RustcLangItemIteratorNext
     | 190 -> Ok RustcLangItemPinNewUnchecked
     | 191 -> Ok RustcLangItemRangeFrom
     | 192 -> Ok RustcLangItemRangeFull
     | 193 -> Ok RustcLangItemRangeInclusiveStruct
     | 194 -> Ok RustcLangItemRangeInclusiveNew
     | 195 -> Ok RustcLangItemRange
     | 196 -> Ok RustcLangItemRangeToInclusive
     | 197 -> Ok RustcLangItemRangeTo
     | 198 -> Ok RustcLangItemRangeMax
     | 199 -> Ok RustcLangItemRangeMin
     | 200 -> Ok RustcLangItemRangeSub
     | 201 -> Ok RustcLangItemRangeFromCopy
     | 202 -> Ok RustcLangItemRangeCopy
     | 203 -> Ok RustcLangItemRangeInclusiveCopy
     | 204 -> Ok RustcLangItemRangeToInclusiveCopy
     | 205 -> Ok RustcLangItemString
     | 206 -> Ok RustcLangItemCStr
     | 207 -> Ok RustcLangItemContractBuildCheckEnsures
     | 208 -> Ok RustcLangItemContractCheckRequires
     | 209 -> Ok RustcLangItemDefaultTrait4
     | 210 -> Ok RustcLangItemDefaultTrait3
     | 211 -> Ok RustcLangItemDefaultTrait2
     | 212 -> Ok RustcLangItemDefaultTrait1
     | 213 -> Ok RustcLangItemContractCheckEnsures
     | 214 -> Ok RustcLangItemReborrow
     | 215 -> Ok RustcLangItemCoerceShared
     | 216 -> Ok RustcLangItemFieldRepresentingType
     | 217 -> Ok RustcLangItemField
     | 218 -> Ok RustcLangItemFieldBase
     | 219 -> Ok RustcLangItemFieldType
     | 220 -> Ok RustcLangItemFieldOffset
     | 221 -> Ok RustcLangItemFrom
     | 222 -> Ok RustcLangItemFromFn
     | 223 -> Ok RustcLangItemFnPtr
     | _ -> Error ("unknown enum variant tag: " ^ string_of_int __tag))
