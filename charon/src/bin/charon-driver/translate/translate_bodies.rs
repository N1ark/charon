...
impl BodyTransCtx<'_, '_, '_> {
    ...
    fn translate_binaryop_kind(&mut self, _span: Span, binop: hax::BinOp) -> Result<BinOp, Error> {
        Ok(match binop {
            ...
            hax::BinOp::AddUnchecked => BinOp::Add,
            hax::BinOp::Sub => BinOp::WrappingSub,
            hax::BinOp::SubUnchecked => BinOp::Sub,
            hax::BinOp::Mul => BinOp::WrappingMul,
            hax::BinOp::MulUnchecked => BinOp::Mul,
            ...
            hax::BinOp::Shl => BinOp::WrappingShl,
            hax::BinOp::ShlUnchecked => BinOp::Shl,
            hax::BinOp::Shr => BinOp::WrappingShr,
            hax::BinOp::ShrUnchecked => BinOp::Shr,
