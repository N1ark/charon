...
.PHONY: test
test: charon-ml/src/CharonVersion.ml charon-py/charon/version.py clean-generated build-dev charon-tests charon-ml-tests charon-py-tests

# Run Charon on various test files
.PHONY: charon-tests
charon-tests:
	cd charon && $(MAKE) test-noclippy

.PHONY: clippy
clippy:
	cd charon && $(MAKE) clippy
...
# Run the charon-py tests on the .ullbc and .llbc files generated by Charon
.PHONY: charon-py-tests
charon-py-tests: charon-py/charon/version.py
	cd charon-py && $(MAKE) tests
